...
FROM python:3.14.7-slim@sha256:cad9a2c871761c413caa6fdd6441c783451e740a48aaeba60ae62a8b53525ef6 AS builder-kicad10
ENV UV_NO_CACHE=1
COPY --from=uv-bin /uv /usr/local/bin/uv
WORKDIR /app
COPY pyproject.toml uv.lock README.md LICENSE ./
...
FROM python:3.14.7-slim@sha256:cad9a2c871761c413caa6fdd6441c783451e740a48aaeba60ae62a8b53525ef6 AS runtime-kicad10
ARG KICAD_MCP_VERSION=0.0.0
ARG VCS_REF=unknown
