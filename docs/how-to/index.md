...
- Run tests: `docs/development/testing-policy.md`
- Add a tool: `docs/development/architecture.md`
- Manage dependencies: `docs/development/dependency-management.md`
- Cut a release: `docs/development/release-process.md`
